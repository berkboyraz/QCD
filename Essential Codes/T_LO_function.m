function T_12= T_LO_function(state_1_index, state_2_index,psic,Ec,z)
...
delta_Ec= abs(Ec(state_2_index)-Ec(state_1_index))*e; % energy difference between 1st and 2nd states, J
