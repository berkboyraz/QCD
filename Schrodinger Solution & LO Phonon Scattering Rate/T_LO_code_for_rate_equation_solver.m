function T_12= T_LO_code_for_rate_equation_solver(state_1_index, state_2_index,psic,Ec,z)
...
delta_Ec= (Ec(state_2_index)-Ec(state_1_index))*e; % energy difference between 1st and 2nd states, J
